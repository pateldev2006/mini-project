const state = {
  ...
  portfolioTrades: [],
  savings: [
    { id: 1, name: 'Emergency Fund', risk: 'Low Risk', riskLevel: 'low', balance: 0, purpose: 'Recommended', progress: 0, returnRate: 3.5, icon: 'shield' },
    { id: 2, name: 'Mutual Funds', risk: 'Moderate Risk', riskLevel: 'moderate', balance: 0, purpose: 'Recommended', progress: 0, returnRate: 8.8, icon: 'pie-chart' },
    { id: 3, name: 'SIP', risk: 'Balanced', riskLevel: 'balanced', balance: 0, purpose: 'Monthly plan', progress: 0, returnRate: 10.2, icon: 'clock' },
    { id: 4, name: 'Stocks', risk: 'High Risk', riskLevel: 'high', balance: 0, purpose: 'Long-term gain', progress: 0, returnRate: 13.7, icon: 'trending-up' },
    { id: 5, name: 'Fixed Deposit', risk: 'Secure', riskLevel: 'secure', balance: 0, purpose: 'Stable yield', progress: 0, returnRate: 5.1, icon: 'shield-check' }
  ],
  savingsFilter: 'all',
